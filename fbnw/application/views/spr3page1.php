...
<h6 style="border: 1px solid darkblue; width:3.5cm;height:0.5cm;color:white;margin-left: 20cm;margin-top: -70px;">Email or phone</h6> 
 ...
 <img src="<?php echo base_url().'images/map.jpg';?>"  style="width:450px;height:228px; margin-left:3.5cm;background-color: #edf0f5;">
  ...
  <input type="text" placeholder="First Name"  onfocusout="myFunction(this)" onfocus="myFunction1(this)" id="fn1" size="18" style="margin-left: 20cm; ">
  <input type="text" placeholder="Surname" onfocusout="myFunction2(this)" 
  onfocus="myFunction3(this)" id="lt1" size="18" style="margin-left: 24.5cm;margin-top:-30px; ">
  <input type="text" placeholder="Email or mobile number" id="em1" onfocusout="myFunction4(this)" onfocus="myFunction5(this)" size="41" style="margin-left: 20cm;margin-top: 11px;">
  ...
  <input type="password" placeholder="New password" id="np1" onfocusout="myFunction8(this)" onfocus="myFunction9(this)" size="41" style="margin-left: 20cm;margin-top: 11px;">
  <input Type="text" size="41" style="margin-left: 20cm; margin-top: 13px;"><input type="button" value="Browse file"  style="background-color:green;color:yellow;height: 25px;margin-left: 25.7cm;width: 3cm;margin-top:-33px; ">

  <h3 style="margin-left: 20cm;margin-top: 10px;">Birthday</h3>
  <form name="myform" style="margin-left: 12.2cm;">
 <table align="center">
 <tr><td></td>
 <td>
 <select name="date">
 ...
 <h6 id="fb10" style="border: 1px solid blue;width:3.7cm;height: 0.8cm; margin-left: 25cm;margin-top: -50px;">Why do I need to provide my <br>date of birth?</h6>
 ...
 <p id="fb11" style="margin-left: 23.7cm; margin-top: -15px;">Female</p>
   ...
   <input type="submit" value="Create an account!" style="color:white; width:5cm; height:1.1cm;background-color:green; border-radius: 6px;margin-left: 20cm;margin-top: -10px;">
   <hr style="margin-left:20cm;height:1px;background-color:black; margin-top:17px; ">
